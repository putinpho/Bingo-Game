...
public class MenuGameSettingOffline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_game_setting_offline);
        ...
        infoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                it.setClass(MenuGameSettingOffline.this, GameInformation.class);
                startActivity(it);
            }
        });
